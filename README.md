...
pau v3.0新增rest api服务,提供对接服务端接口的支持,并利用jwt token鉴权机制给予客户端的访问权限,传输数据进行md5签名保证传输过程数据的安全性!

pau v3.1新增集成工作流引擎flowable6.2.0!

## 最新pau技术文档
pau框架有作者在业余时间整理的技术文档,详情点击[查看详情](https://github.com/guoop/.git)

## 最新pau视频教程
pau框架有作者在业余时间录制的视频教程,详情点击[教程介绍](https://github.com/guoop/.git
...
6. controller层采用map + warpper方式的返回结果，返回给前端更为灵活的数据，具体参见com.stylefeng.pau.modular.system.warpper包中具体类。
...
```
@Configuration
@MapperScan(basePackages = {"com.stylefeng.pau.modular.*.dao", "com.stylefeng.pau.common.persistence.dao"})
